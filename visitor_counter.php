...
$con=mysqli_connect('localhost','root','','blood_bank_1');
...
<div class='row' style='margin-left:500px;margin-top:200px'>
 <div class='col-4'>
  <h2 class='text-danger'>Total Visits</h2>
 </div>
 <div class='col-8'>
  <table class='text-white bg-info table-sm'> 
   <tr>
      <td style='border:1px solid black'><?php echo $counter[0] ?></td>
      <td style='border:1px solid yellow'><?php echo $counter[1] ?></td>
      <td style='border:1px solid black'><?php echo $counter[2] ?></td>
      <td style='border:1px solid yellow'><?php echo $counter[3] ?></td>
      <td style='border:1px solid black'><?php echo $counter[4] ?></td>
      <td style='border:1px solid yellow'><?php echo $counter[5] ?></td>
      <td style='border:1px solid black'><?php echo $counter[6] ?></td>
      <td style='border:1px solid yellow'><?php echo $counter[7] ?></td>
      <td style='border:1px solid black'><?php echo $counter[8] ?></td>
    </tr>
  </table>
 </div>
</div>
